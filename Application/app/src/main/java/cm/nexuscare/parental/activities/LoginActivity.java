...
import cm.nexuscare.parental.dialogfragments.RecoverPasswordDialogFragment;
				...
				public void onComplete(@NonNull Task<AuthResult> task) {
					...
					if (task.isSuccessful()) {
						...
						if (ex instanceof FirebaseAuthException) {
							errorCode = ((FirebaseAuthException) ex).getErrorCode();
						}
						if (errorCode == null) errorCode = "ERROR_UNKNOWN";
