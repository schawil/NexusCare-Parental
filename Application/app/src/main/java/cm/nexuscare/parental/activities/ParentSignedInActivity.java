...
import cm.nexuscare.parental.adapters.ChildAdapter;
import cm.nexuscare.parental.dialogfragments.PhoneLockDialogFragment;
import cm.nexuscare.parental.interfaces.OnChildClickListener;
...
public class ParentSignedInActivity extends AppCompatActivity implements OnChildClickListener {
	...
	public static final String APPS_EXTRA = "cm.nexuscare.parental.activities.APPS_EXTRA";
	public static final String CHILD_NAME_EXTRA = "cm.nexuscare.parental.activities.CHILD_NAME_EXTRA";
	public static final String CHILD_EMAIL_EXTRA = "cm.nexuscare.parental.activities.CHILD_EMAIL_EXTRA";
	public static final String PARENT_EMAIL_EXTRA = "cm.nexuscare.parental.activities.PARENT_EMAIL_EXTRA";
	public static final String CHILD_IMG_EXTRA = "cm.nexuscare.parental.activities.CHILD_IMG_EXTRA";
	public static final String CHILD_MESSAGES_EXTRA = "cm.nexuscare.parental.activities.CHILD_MESSAGES_EXTRA";
	public static final String CHILD_CALLS_EXTRA = "cm.nexuscare.parental.activities.CHILD_CALLS_EXTRA";
