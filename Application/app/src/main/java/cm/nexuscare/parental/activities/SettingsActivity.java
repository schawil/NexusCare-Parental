...
import cm.nexuscare.parental.dialogfragments.AccountDeleteDialogFragment;
import cm.nexuscare.parental.dialogfragments.ConfirmationDialogFragment;
import cm.nexuscare.parental.dialogfragments.LanguageSelectionDialogFragment;
import cm.nexuscare.parental.dialogfragments.PasswordChangingDialogFragment;
...
import cm.nexuscare.parental.utils.AccountUtils;
import cm.nexuscare.parental.utils.Constant;
import cm.nexuscare.parental.utils.LocaleUtils;
...
public class SettingsActivity extends AppCompatActivity implements OnLanguageSelectionListener, OnConfirmationListener, OnPasswordChangeListener, OnDeleteAccountListener {
	...
	private void SendFeedBack() {
		...
		intent.putExtra(Intent.EXTRA_SUBJECT, "NexusCare Feedback");
		intent.putExtra(Intent.EXTRA_TEXT, body);
		startActivity(Intent.createChooser(intent, getString(R.string.choose_email_client)));
	}
	
	private void visitWebsite() {
		Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://xmansour.github.io/NexusCare"));
