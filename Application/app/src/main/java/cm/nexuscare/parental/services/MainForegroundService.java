package cm.nexuscare.parental.services;
...
import cm.nexuscare.parental.activities.BlockedAppActivity;
import cm.nexuscare.parental.activities.ChildSignedInActivity;
import cm.nexuscare.parental.broadcasts.AppInstalledReceiver;
import cm.nexuscare.parental.broadcasts.AppRemovedReceiver;
import cm.nexuscare.parental.broadcasts.PhoneStateReceiver;
import cm.nexuscare.parental.broadcasts.ScreenTimeReceiver;
import cm.nexuscare.parental.broadcasts.SmsReceiver;
import cm.nexuscare.parental.models.App;
import cm.nexuscare.parental.models.Child;
import cm.nexuscare.parental.models.Contact;
import cm.nexuscare.parental.models.ScreenLock;
...
import static cm.nexuscare.parental.NotificationChannelCreator.CHANNEL_ID;
...
public class MainForegroundService extends Service {
	...
	public static final String BLOCKED_APP_NAME_EXTRA = "cm.nexuscare.parental.services.BLOCKED_APP_NAME_EXTRA";
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
				...
				.setSmallIcon(R.drawable.ic_nexuscare).setContentIntent(pendingIntent).build();
	...
	private void setFence(DataSnapshot dataSnapshot) {
		final cm.nexuscare.parental.models.Location childLocation = dataSnapshot.getValue(cm.nexuscare.parental.models.Location.class);
	...
	private String getLollipopForegroundAppPackageName() {
		...
		try {
			...
			for (UsageStats stats : foregroundApps) {
                /*if (i == 0 && !"cm.nexuscare.parental".equals(stats.getPackageName())) {
